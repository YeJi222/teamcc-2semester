...
function head_function(){
  return `
    ...
    <link rel="stylesheet" href="/teamcc/fonts/fonts.css" />
          ...
          <head>
            ...
            <script>
              ...
              function deleteFunction(inputText){
                if(inputText == "삭제요청"){
                  location.href = '/teamcc/initialization';
                } else{
              ...
              <div class="container px-5" id="navbar-grid" style="margin: 0; display:grid; grid-template-columns: 30vw 60vw;">
                ...
                <div id="navbar-item" style="grid-column:2; text-align:right;">
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <div class="navbar-rg-item"><img onclick="location.href='/teamcc/admin_profile'" src="teamcc/assets/img/profileIcon.png" width="40px;"></div>
                  </div>
                </div>
              </div>
            </nav>
            ...
            <header class="masthead text-center text-white" style="height:400px; background-image:url('${background_image_tag}')";>
              <div class="masthead-content">
                <div class="container px-5">
                  <h3 class="masthead-heading mb-0" style="color: black;">${team_info[0].title}</h3>
                </div>
              </div>
            </header>
                      ...
                      <div class="p-5">
                        <div class="main-grid-user">
                          ...
                          <div class="wrapper" style="grid-row:1; grid-column:3; margin-left:20px; text-align:left; height: 40px; margin-right: 20px;">
                            ...
                            <a href="/teamcc/change_url_state" id="change_url_link"></a>
                          </div>
                          <script>
                          ...
                          <div class="main-gallery-div">
                            <a href="/teamcc/team_gallery" class="btn btn-primary btn-xl rounded-pill a-usertable">Gallery</a>
                          </div>
                        </div>
          ...
          <body id="page-top">
            ...
            <div class="middlePart">
              ...
              <div style="text-align: center">
                <a href="/teamcc/admin_main" class="btn btn-primary btn-xl rounded-pill mt-5" style="width:180px;">BACK</a>
              </div>
              <div id="mid_container">
                <button type="button" id="modal_bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal" style="display:none;"> </button>
              </div>
              ...
              <div class="masthead-content" style="margin-top: -60px">
                <div class="container px-5 containerCSS">
                  <div class='title'>
                      ...
                      <span class='spanTitle'>CC</span> <br>
                      <span class='spanTitle'>SERVICE</span>
                  </div>
                  <br><br>
                  ...
                  <form style="  margin:auto;width:400px;" action="/teamcc/login_action" method="post">
                    <div id="grid">
                      ...
                      <input id="bt_login" type="submit" value="LOGIN" class="loginBtn"></input>
                      <a class="registerBtn" href="teamcc/admin_register">REGISTER</a>
                    </div>
                  </form>
                </div>
              </div>
    ...
    return`
      ...
      <html lang="en" style="background-color: black">
        ...
        <body id="page-top" class="backgroundCSS">
          ...
          <!-- Header-->
          <header style="height: 90%;" class="masthead text-center text-white fixedHeader">
              ...
              <div class="container px-5">
                ...
                <form style="  margin:auto;width:400px;" action="teamcc/admin_register_state" method="post">
                  <div id="grid">
                    ...
                    <input id="bt_login" type="submit" value="CREATE" class="createBtn" ></input>
                  </div>
                </form>
                <a href="/teamcc/" class="backText"><div class="backBtn">BACK</div></a>
          ...
          <script>
            function profile_edit(){
              ...
              $.ajax({
                type:'post',
                async:false,
                url:'/teamcc/admin_profile_check',
                dataType:'text',
                data:{
          ...
          <header class="masthead text-center text-white"  >
            <div class="masthead-content" >
              <div class="container px-5" style=" background: #e8e8e85c;border-radius: 10px; padding-bottom: 100px; padding-top: 120px;">
                <div class="closeInfo" onclick="location.href='/teamcc/admin_main'">X</div>
      ...
      <html lang="en">
        ...
        <body id="page-top">
          ...
          <header class="masthead text-center text-white" style="height:400px; background-image:url('${background_image_tag}')";>
            <div class="masthead-content">
              <div class="container px-5">
                <h3 class="masthead-heading mb-0 style="color: black;">${team_info[0].title} TEAM CC</h3>
              </div>
            </div>
          </header>
      ...
      <html lang="en">
          ...
          <script>
            ...
            function change_scoretext(adminID,score,color){
              $.ajax({
                type:'post',
                async:false,
                url:'/teamcc/change_color_scoretext',
                dataType:'text',
                data:{
                  adminID:adminID,
                  score:score+'_text',
        ...
        <body id="page-top">
          ...
          <header class="masthead text-center text-white" style="height:400px; background-image:url('${background_image_tag}')";>
            <div class="masthead-content">
              <div class="container px-5">
                <h3 class="masthead-heading mb-0 style="color: black;">${team_info.title}</h3>
              </div>
            </div>
          </header>
    ...
    var tag = `
      <tr>
        ...
        <th width=400px>
          ...
          <div class="thTextCSS" style="background-color: #CAA1E3; color: white; width: 130px;">Activity</div>
        </th>
        <th width=100px>
  ...
  function_urlTable:function(url,team_num){
    var tag = `
      <tr>
        ...
        <th width=150px>
          <div class="thCSS" style="background-color: #CAA1E3;"></div>
          <div class="thTextCSS" style="background-color: #CAA1E3; color: white; width: 130px;">Link</div>
        </th>
        <th>
          <div class="thCSS" style="background-color: #354B9B;"></div>
    ...
    for(var i = 0; i< url.length; i++){
      tag +=`
        <tr>
          ...
          <td class="tdCSS"><a href="/teamcc/user?id=${url[i].url}">${url[i].url}</td>
          <td class="tdCSS">
          ...
          <td class="tdCSS">
            <button class="bt-copy" onClick="copy_clipboard('/teamcc/user?id=${url[i].url}','img-copy${url[i].team_num}')">
          ...
          <td class="tdCSS">
            ...
            <script type="text/javascript">
              function kakaoShare(url_num) {
                  ...
                  content : {
                    title:"Team CC 링크",
                    description:"teamccapp.store/teamcc/user?id=" + url_num,  // 콘텐츠 설명
                    imageUrl:"https://ifh.cc/g/G9xtP5.jpg", // 썸네일 같은거
                    link : {
		      mobileWebUrl:"http://teamccapp.store/teamcc/user?id=" + url_num,    // 모바일 카카오톡에서 사용하는 웹 링크 URL
                      webUrl:"http://teamccapp.store/teamcc/user?id=" + url_num  // PC버전 카카오톡에서 사용하는 웹 링크 URL
                    }
                  },
                  buttons : [{
            ...
            <a href="/teamcc/admin_main" id="kakao_href"></a>
            <img src="teamcc/assets/img/kakao.png" onClick="kakaoShare('${url[i].url}');" width="50" alt="Share" class="btnImg">
            </form>
          </td>
        </tr>`;
    }
